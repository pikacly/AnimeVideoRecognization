;(function ($, window) {
    ...
    category.fn._render = function (cid, level) {
        ...
        if (li.length == 0) {
            li = $("<li id=\"li_categoryItem" + this._index + "_" + level + "\" style=\"display: block; float: left; clear: none; margin: 0; padding: 0; width: 33.333%; height: 170px; border: 0; overflow-y: scroll; overflow-x: hidden; background: #FFF; color: #333; font: 14px arial, helvetica, clean;\"></li>");
        ...
        for(var i = 0; i < sourceData[c.list].length; i++){
            ...
            var span = $("<span id=\"span_categoryItem" + this._index + "_" + item[c.cid] + "\" style=\"overflow:hidden; display:block; float:left; margin: 0; padding: 0; width:300px; height: 35px; line-height:14px; font: 14px arial, helvetica, clean; color: #333; vertical-align: middle;word-break:keep-all;word-wrap:normal;\"></span>");
            span.text(item[c.name]);
            span.attr("title", item[c.name].replace("\"", "&quot").replace("'","&acute;"));
            var p = $("<p id=\"p_categoryItem" + this._index + "_" + item[c.cid] + "\" style=\"overflow:hidden; display:block; float:left; margin: 0; clear: both; padding: 5px; width:300px; height: 35px; cursor: default;\"></p>");
    ...
    category.defaults = {
        ...
        template:"<div class='cate-select-div' style=\"position:relative;width:100%;z-index:5;margin:0;padding:0;display:block;color:#333;font:14px arial,helvetica,clean;\"><span id=\"span_button\" tabindex=\"-1\" hidefocus=\"true\" cidstr=\"\"cids=\"\" obj=\"\" beforetext=\"\" style=\"background:{bg_img_button};display:inline-block;height:35px;line-height:18px;padding:5px 10px;border:1px solid #E1E1E1;cursor:pointer;outline:0;\"><span id=\"span_nameView\" style=\"_position:relative;_top:2px;line-height:18px;cursor:pointer;color:#333;font:14px arial,helvetica,clean;\">请选择分类</span> <b id=\"b_buttonIcon\" style=\"background:{bg_img_arrow_down};display:-moz-inline-stack;display:inline-block;padding:0;vertical-align:-2px;font-size:0;line-height:9999em;overflow:hidden;position:relative;width:16px;height:16px;margin-left:5px!important;font-style:normal;font-weight:normal;cursor:pointer;color:#333;\"></b></span><div id=\"div_popLayout\" tabindex=\"17\" hidefocus=\"true\" style=\"display:none;position:absolute;top:29px;left:0;z-index:10;box-shadow:3px 3px 5px rgba(0, 0, 0, 0.1);outline:0;border:1px solid #AAA;background:#FFF;clip:rect(0 602px 202px 0);height:171px;margin:-1px;margin-top:6px;overflow:hidden;padding:0;width:553px;color:#333;font:14px arial, helvetica, clean;\"><div style=\"* zoom:1;_display:inline;display:block;margin:0;padding:0;\"><ul id=\"ul_cateView\" style=\"list-style:none;margin:0;padding:0;display:block;\"></ul></div></div></div>",
        sourceData:{ list:[] },
        button:"span_button",
