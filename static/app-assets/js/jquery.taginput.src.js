...
;(function ( $, window, document, undefined ) {
    ...
    stylePresets = {
        ...
        oais: {
        	tagTpl: '<li class="select2-selection__choice" title="Washington"><span class="select2-selection__choice__remove" role="presentation">×</span>{{label}}</li>',
            wrapperTpl: '<div class="taginput-wrapper form-control"><span class="select2 select2-container select2-container--default" dir="ltr""><span class="selection"><span class="select2-selection select2-selection--multiple" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="-1"><ul class="select2-selection__rendered"></ul></span></span></span></div>',
            deleteHandler: null
        }
    },
