/*! jquery.add-input-area v4.11.0 | Yuusaku Miyazaki <toumin.m7@gmail.com> | license: MIT */
!
function(t) {
    var e = {};
    function n(i) {
    ...
    n.t = function(t, e) {
        ...
        if (n.r(i), Object.defineProperty(i, "default", {
            enumerable: !0,
            value: t
        }), 2 & e && "string" != typeof t) for (var a in t) n.d(i, a,
        function(e) {
            return t[e]
        }.bind(null, a));
        return i
    ...
    var i = {
        _setOption: function(t, e) {
            ...
            t)).area_del || (t.area_del = t.btn_del),
            t
        },
        ...
        _ehDelBtn: function(t) {
            ...
            $(this.elem).find(this.option.area_var).eq(e).remove(),
            this._setDelBtnVisibility(),
            this._renumberFieldAll(),
            this.option.maximum > 0 && $(this.elem).find(this.option.area_var).length < this.option.maximum && $(this.option.btn_add).show()
        },
        ...
        _renumberFieldEach: function(t, e) {
            var n = this;
            $(e).find("[name]").each(function() {
                $(this).attr("name", n._getValOfAttr(this, t, "name")),
                $(this).attr("id", n._getValOfAttr(this, t, "id"))
    ...
    $.addInputArea = function(t, e) {
        ...
        this._setDelBtnVisibility();
        var n = this;
    	$(document).off("click", this.option.btn_add)
    	$(n.elem).off("click", n.option.btn_del)
        $(document).on("click", this.option.btn_add,
        function() {
            n._ehAddBtn.call(n)
        }),
        $(n.elem).on("click", n.option.btn_del,
        function(t) {
            n._ehDelBtn.call(n, t)
        }),
        this._renumberFieldAll(),
        this.option.original = $(this.elem).find(this.option.area_var).eq(0).clone(this.option.clone_event),
        this.option.dont_clone && $(this.option.original).find(this.option.dont_clone).detach()
    },
